...
def main(project_scenario: str) -> None:
    ...
    if args.organ_t2_supervision_strategy and (project_scenario != "organ"
            or (args.method not in ("zs-derpp", "zs-sequential") and not args.organ_report_schedule)
    ...
    if args.organ_retention_strategy and (project_scenario != "organ"
            or (args.method not in ("zs-derpp", "zs-sequential") and not args.organ_report_schedule) or args.organ_task
