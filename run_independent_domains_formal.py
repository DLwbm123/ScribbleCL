...
def main():
    ...
    protocol = {
        ...
        "spatial_first_epoch_index": 5, "configuration_selected_on": "A validation",
...
def self_check():
    ...
    for fail in (False, True):
        with TemporaryDirectory() as directory:
            ...
            def train(args, name, weight, epochs, gpu, test, task):
            ...
            argv = [__file__, "--data-root", directory, "--sparse-root", directory,
                    "--completed-a", directory, "--output", str(root / "output")]
